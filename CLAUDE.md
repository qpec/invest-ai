...
- **Circle of competence.** Only businesses the owner genuinely understands: cloud infrastructure, healthcare/insurance tech, SaaS platforms, AI tooling. If the business model and its moat cannot be explained in two sentences, PASS.
...
- **Specific knowledge.** The owner's deepest edge is the intersection of cloud architecture, healthcare systems, and AI implementation. Weight analysis toward this edge; build income streams around knowledge that feels like play.
...
- **Productize yourself.** US citizen in the Netherlands with deep enterprise-AI expertise is unique positioning: consulting, content, advisory, angel investing in understood sectors.
...
- US citizen residing in the Netherlands (relevant for tax treatment of funds vs. individual stocks; base currency EUR, most holdings likely USD)
- Leads enterprise AI teams at Menzis; writes on Medium
- Circle of competence: cloud infrastructure, healthcare/insurance tech, SaaS, AI tooling
