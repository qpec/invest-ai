...
def test_build_status_context_reports_last_run_state(tmp_db, fixed_clock):
    ...
    assert "2026-07-08" not in ctx.next_scheduled_line  # next fire is AFTER the last due key
...
def test_build_status_context_surfaces_open_decision_as_loop(tmp_db, fixed_clock):
